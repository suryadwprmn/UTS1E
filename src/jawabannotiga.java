...
public class jawabannotiga {
    ...
    public static void tampilkansemuadatapenumpang (){
        ...
        System.out.println();
        System.out.println("\nSisa kuota Orang Top Level adalah " + toplevelData);
        System.out.println("Sisa kuota Orang Middle Level adalah " + middleleveldata);
        System.out.println("Sisa kuota Orang Regular Staff adalah " + regularstaffdata);
        System.out.println("Sisa kuota Orang Staff adalah " + staffdata);
